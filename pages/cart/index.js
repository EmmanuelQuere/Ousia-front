    ...
    <div className="container mx-auto mt-10">
      <div className="lg:flex shadow-md my-10">
        <div className="w-full bg-white px-10 py-10">
          ...
          <Link href="/shop">
            <a className="flex font-semibold text-ousiaBlue text-sm mt-10">
              <svg className="fill-current mr-2 text-ousiaBlue w-4" viewBox="0 0 448 512"><path d="M134.059 296H436c6.627 0 12-5.373 12-12v-56c0-6.627-5.373-12-12-12H134.059v-46.059c0-21.382-25.851-32.09-40.971-16.971L7.029 239.029c-9.373 9.373-9.373 24.569 0 33.941l86.059 86.059c15.119 15.119 40.971 4.411 40.971-16.971V296z" /></svg>
              Retour à la boutique
            </a>
          </Link>
        </div>

        {(!currentUserCart || currentUserCart.length === 0) || <div id="summary" className="lg:w-1/4 px-8 py-10 bg-white">
          ...
          <div className="border-t mt-8">
            ...
            {userToken ?
              <Link href={'/cart/recap'}>
                <button className="bg-ousiaBlue font-semibold hover:bg-indigo-600 py-3 text-sm text-white uppercase w-full">Payer ma commande</button>
              </Link>
              :
              <Link href={'/signup'}>
                <button className="bg-ousiaBlue font-semibold hover:bg-indigo-600 py-3 text-sm text-white uppercase w-full">Payer ma commande</button>
