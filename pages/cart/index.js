    ...
    <div className="flex shadow-md my-10">
      <div className="w-3/4 bg-white px-10 py-10">
        ...
        <div className="flex mt-10 mb-5">
          ...
          {!currentUserCart ? <span className="text-gray-600 text-lg">Vous n'avez pas encore d'articles dans votre panier !</span> : currentUserCart.map(cartItem => <CartProduct key={cartItem.id} product={cartItem.item} quantity={cartItem.quantity} item_id={cartItem.id} setCurrentUserCart={setCurrentUserCart} currentUserCart={currentUserCart}/>)}
          <Link href="/shop">
