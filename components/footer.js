    ...
    return (
        ...
        <>
            <div className=" bg-gray-200  pb-12">
                <div className="mx-auto container pt-10 lg:pt-10 flex flex-col items-center justify-center mt-4">
                    <div>
                        <Image src="/logo.png" width={92} height={92} viewBox="0 0 79 92" fill="none" />
                    </div>
                    <div className="text-black flex flex-col md:items-center f-f-l pt-3">
                    <h2 className="font-size text-sm font-bold">Rejoignez la communauté des Ousiologues</h2> 
