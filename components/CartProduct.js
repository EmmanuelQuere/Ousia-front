  ...
  return (
    <div className="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5">
      ...
      <div className="flex justify-center w-1/5">
        ...
        <input className="mx-2 border text-center w-8" type="text" defaultValue={`${props.quantity}`}></input>
      ...
      <span className="text-center w-1/5 font-semibold text-sm">{props.product.price*props.quantity} €</span>
    </div>
  )
}
